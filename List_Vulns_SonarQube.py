...
TOKEN = "9fca0d071e2eea9b3e9cad282db3a33060d9d386"
...
def crearArchivos(data):
    ...
    with open('ListaDeVulnsSonar_full.json') as json_file:
        ...
        wb = Workbook()
        ws = wb.active
        with open('ListaDeVulnsSonar_full.csv', 'r') as f:
            for row in csv.reader(f):
                ws.append(row)
        wb.save('ListaDeVulnsSonar_full.xlsx')
...
def crearArchivos_proyecto(data,proyecto):
    ...
    with open('ListaDeVulnsSonar_'+proyecto+'.json') as json_file:
        ...
        wb = Workbook()
        ws = wb.active
        with open('ListaDeVulnsSonar_'+proyecto+'.csv', 'r') as f:
            for row in csv.reader(f):
                ws.append(row)
        wb.save('ListaDeVulnsSonar_'+proyecto+'.xlsx')
